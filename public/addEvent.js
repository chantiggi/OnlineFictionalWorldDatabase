module.exports = function(){
  ...
  router.post('/', function(req,res){
    ...
    var sql = "INSERT INTO `Event`(`eventName`, `eventDescription`, `eventLocation`, `univID`) "
    + "VALUES (?, ?, ?, ?)";
    var inserts = [req.body.eventName, req.body.eventDescription, req.body.eventLocation, req.body.univID];
